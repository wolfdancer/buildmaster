...
The BuildMaster project follows strict rules that govern its use of version
...
Before a new major or minor release, BuildMaster will make release
...
A release candidate does not guarantee backward compatability with
